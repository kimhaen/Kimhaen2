		...
		<colspan>
			...
			<tbody>
				<form name="my" method="post" action="" onclick="onSubmit()" enctype="multipart/form-data">
					...
					<tr>
						<th>첨부</th>
						<td><input type="file" name="filename" value="upload/${vo.filename}">
						<input type="hidden" name="file1" value="upload/${vo.filename}">
						</td>
					</tr>
				<tr>
					<td colspan="2">
						<input type="button" value="수정" class="btn-write" onclick="onSubmit()">&nbsp;&nbsp;&nbsp;
...
<script>
	...
	function onSubmit(){
		...
		if(my.filename.value==""){
			...
			my.action.value = "gallerymodify.do";
			my.submit();
	}
